...
import { SearchCandidatesListsParams } from '../../../../../api/payments/lists/search-candidates-lists-params';
import { WbListCandidateBatch } from '../../../../../api/fb-management/swagger-codegen/model/wbListCandidateBatch';

@Injectable()
export class FetchCandidatesService extends PartialFetcher<WbListCandidateBatch, SearchCandidatesListsParams> {
    ...
    fetch(params: SearchCandidatesListsParams): Observable<FetchResult<WbListCandidateBatch>> {
